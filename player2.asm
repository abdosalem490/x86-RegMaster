...
personTurnIndex     DB 0    ; if 0 then its my turn on my device , if 1 then its opponent turn on his device (used in communication)
...
LOCAL CHK6,DonotInGameChatting
	...
	;send to him which page we will chat on
	MOV DX,03F8H 
...
inGameChat	PROC
	...
	printMessage messageRecieved,opponentName,messageRecievedRow,messageRecievedCOL
	...
	printMessage messageToBeSend,yourName,messageRecievedRow,messageRecievedCOL
	MOV messageRecievedCOL,51
	INC messageRecievedRow
...
firstInputCommand PROC
	...
	;check if its outGameChat or InGame
    CALL inGameChat
